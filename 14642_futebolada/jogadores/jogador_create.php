...
if (!empty($_POST)) {
    ...
    // Check if POST variable "nome" exists, if not default the value to blank, basically the same for all variables
...
<div class="content update">
    ...
    <form action="tabela_create.php" method="post">
        ...
        <input type="text" required name="nome" placeholder="Escreva o nome do jogador" id="nome">
